<template>
	<div class="books_container">
		<h1 style="text-align: center;">Welcome to AYD Online Books Library</h1>		
		<el-divider />
		...
		<div class="books_table">
			...
			<div else>
				<el-table :data="list_data.list" style="width: 100%" :cell-class-name="lowStockAlert" stripe border>
					...
					<el-table-column prop="isbn" label="ISBN" width="130px"></el-table-column>
					...
					<el-table-column label="Actions" fixed="right" width="200px">
						<template slot-scope="scope">
							<el-button type="text" size="small">Borrow</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination 
